...
def _dinfo_init(
    ...
    return {
        ...
        "library_names": library_names or depset(),
        "library_paths": library_paths or depset(),
...
DInfo, _new_dinfo = provider(
    ...
    fields = {
        ...
        "library_names": "A depset of library names.",
        "library_paths": "A depset of library paths.",
